          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="get" action="{{route('SearchOrder')}}">
        ...
        <div class="main-panel">
                        ...
                        @foreach ($data as $order)
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <span class="pl-2">{{$order->foodname}}</span>
                            </td>
                            <td> {{$order->price}} </td>
                            ...
                            <td>
                                <a class="badge badge-outline-danger" href="{{route('DeleteOrder',$order->id)}}">Delete</a> 
                             </td>
          ...
          <footer class="footer">
            ...
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Abdelhamid Touil</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">  from Bootstrapdash.com</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
