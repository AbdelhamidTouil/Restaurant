          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <!-- search -->
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="get" action="{{route('SearchUser')}}">
        ...
        <div class="main-panel">
                      ...
                      <table class="table">
                        ...
                        @foreach ($data as $user)
                          ...
                          <tr>
                            ...
                            @if ($user->usertype == 0)
                            <td>
                                <a class="badge badge-outline-success" href="{{route('Delete',$user->id)}}">Delete</a> 
                             </td>

                             @else
                             <td>
                                <a class="badge badge-outline-primary" href="">Not Allowed</a>
                            </td>
                             @endif
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> admin templates from Bootstrapdash</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
