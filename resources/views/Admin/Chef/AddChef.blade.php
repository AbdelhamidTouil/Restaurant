...
<form action="{{route('StoreChef')}}" method="POST" enctype="multipart/form-data">
  @csrf
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="add-items">
                              ...
                              <input type="text" name="speciality" class="form-control todo-list-input" placeholder="enter description.." required>
                            </div>
                            <div class="add-items">
