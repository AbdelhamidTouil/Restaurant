...
<form action="{{route('UpdateChef',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
  @csrf
                      ...
                      <div class="col-md-12 col-xl-4 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="add-items">
                              <label for="">Specfiality</label>
                              <input type="text" name="speciality" class="form-control todo-list-input" value="{{$data->speciality}}" required>
                            </div>
                            <div class="add-items">
                              <label for="">Old Image</label>
                              
                              <img width="80px" height="80px" src="/images/Chef/{{$data->image}}" alt="{{$data->name}}">
                            </div>
