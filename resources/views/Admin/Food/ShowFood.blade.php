          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"  aria-expanded="false" href="{{route('AddFood')}}">+ Create New Food</a>
        ...
        <div class="main-panel">
                      ...
                      <table class="table">
                        ...
                        @foreach ($data as $food)
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="/images/Food/{{$food->image}}" alt="{{$food->name}}" />
                            ...
                            <td>
                                <a class="badge badge-outline-danger" href="{{route('DeleteFood',$food->id)}}">Delete</a> 
                             </td>
                             <td>
                              <a class="badge badge-outline-success" href="{{route('EditFood',$food->id)}}">Edit</a> 
                           </td>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">  admin templates from Bootstrapdash.com</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
