...
<form action="{{route('UpdateFood',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
  @csrf
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="add-items">
                              ...
                              <input type="text" name="name" class="form-control todo-list-input" value="{{$data->name}}" required>
                            </div>
                            
                            <div class="add-items">
                              <label for="">price</label>
                              <input type="text" name="price" class="form-control todo-list-input" value="{{$data->price}}" required>
                            </div>

                            <div class="add-items">
                              <label for="">description</label>
                              <input type="text" name="description" class="form-control todo-list-input" value="{{$data->description}}" required>
                            </div>

                            <div class="add-items">
                              <label for="">Old Image</label>
                              
                              <img width="80px" height="80px" src="/images/Food/{{$data->image}}" alt="{{$data->name}}">
                            </div>

                            <div class="add-items">
                              <label for=""> New Image</label>
                              <input type="file" name='image' class="form-control todo-list-input" required>
                            </div>
