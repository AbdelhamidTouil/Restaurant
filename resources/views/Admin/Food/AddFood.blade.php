                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="add-items">
                              ...
                              <input type="text" name="name" class="form-control todo-list-input" placeholder="enter name.." required>
                            </div>
                            <div class="add-items">
                              <label for="">Price</label>
                              <input type="text" name="price" class="form-control todo-list-input" placeholder="enter price.." required>
                            </div>
                            <div class="add-items">
                              <label for="">Description</label>
                              <input type="text" name="description" class="form-control todo-list-input" placeholder="enter description.." required>
                            </div>
                            <div class="add-items">
